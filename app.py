...
def gerar_laudo_pdf(vu, min_v, max_v, fund, prec, eq_str, total, n, features):
    buffer = io.BytesIO()
    ...
    c.drawString(50, 765, f"Equação: {eq_str[:70]}...")
